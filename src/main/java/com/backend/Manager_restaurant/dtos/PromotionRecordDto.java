...
public record PromotionRecordDto(String description_promotional, BigDecimal price_promotional, List<HourPromotion> hourPromotions, List<Product> products, List<Restaurant> restaurants){
}
